...
namespace API.PastillApp.Repositories.Migrations
{
    ...
    [Migration("20231031234237_emergencyNotification")]
    partial class emergencyNotification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.PastillApp.Domain.Entities.EmergencyContactRequest", b =>
                {
                    b.Property<int>("EmergencyContactRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmergencyContactRequestId"));
                    ...
                    b.HasKey("EmergencyContactRequestId");

                    b.HasIndex("UserRequestId");

                    b.ToTable("EmergencyContactRequests");
                });
            ...
            modelBuilder.Entity("API.PastillApp.Domain.Entities.ReminderLog", b =>
                {
                    ...
                    b.Property<bool>("EmergencyNotification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("API.PastillApp.Domain.Entities.EmergencyContactRequest", b =>
                {
                    b.HasOne("API.PastillApp.Domain.Entities.User", "UserRequest")
                        .WithMany()
